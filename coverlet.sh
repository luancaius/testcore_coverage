...
coverlet "$TEST_ASSEMBLY1" --target "dotnet" --targetargs "test $PROJECT_ASSEMBLY1" --merge-with "./coverage.json" --format json
coverlet "$TEST_ASSEMBLY2" --target "dotnet" --targetargs "test $PROJECT_ASSEMBLY2" --merge-with "./coverage.json" --format json
coverlet "$TEST_ASSEMBLY3" --target "dotnet" --targetargs "test $PROJECT_ASSEMBLY3" --merge-with "./coverage.json" --format json
